...
const regionalWords: Concept[] = [
  {
    ...
    terms: { PE: 'canchita', MX: 'palomitas', AR: 'pochoclo', CO: 'crispetas', CL: 'cabritas', ES: 'palomitas' },
  },
  {
    id: 'avocado',
    defaultTerm: 'aguacate',
    terms: { PE: 'palta', MX: 'aguacate', AR: 'palta', CO: 'aguacate', CL: 'palta', ES: 'aguacate' },
  },
  {
    id: 'straw',
    defaultTerm: 'pajita',
    terms: { PE: 'cañita', MX: 'popote', AR: 'sorbete', CO: 'pitillo', CL: 'bombilla', ES: 'pajita' },
  },
  {
    id: 'beans',
    defaultTerm: 'frijoles',
    terms: { PE: 'frejoles', MX: 'frijoles', AR: 'porotos', CO: 'fríjoles', CL: 'porotos', ES: 'alubias' },
  },
  {
    id: 'fridge',
    defaultTerm: 'refrigerador',
    terms: { PE: 'refrigeradora', MX: 'refrigerador', AR: 'heladera', CO: 'nevera', CL: 'refrigerador', ES: 'nevera' },
  },
  {
    id: 'tshirt',
    defaultTerm: 'camiseta',
    terms: { PE: 'polo', MX: 'playera', AR: 'remera', CO: 'camiseta', CL: 'polera', ES: 'camiseta' },
  },
  {
    id: 'pen',
    defaultTerm: 'bolígrafo',
    terms: { PE: 'lapicero', MX: 'pluma', AR: 'birome', CO: 'esfero', CL: 'lápiz pasta', ES: 'bolígrafo' },
  },
  {
    id: 'corn',
    defaultTerm: 'maíz',
    terms: { PE: 'choclo', MX: 'elote', AR: 'choclo', CO: 'mazorca', CL: 'choclo', ES: 'maíz' },
  },
  {
    id: 'peanuts',
    defaultTerm: 'cacahuetes',
    terms: { PE: 'maní', MX: 'cacahuates', AR: 'maní', CO: 'maní', CL: 'maní', ES: 'cacahuetes' },
  },
  {
    id: 'peach',
    defaultTerm: 'melocotón',
    terms: { PE: 'durazno', MX: 'durazno', AR: 'durazno', CO: 'durazno', CL: 'durazno', ES: 'melocotón' },
  },
  {
    id: 'cake',
    defaultTerm: 'pastel',
    terms: { PE: 'torta', MX: 'pastel', AR: 'torta', CO: 'torta', CL: 'torta', ES: 'tarta' },
  },
  {
    id: 'car',
    defaultTerm: 'coche',
    terms: { PE: 'carro', MX: 'coche', AR: 'auto', CO: 'carro', CL: 'auto', ES: 'coche' },
  },
  {
    id: 'apartment',
    defaultTerm: 'apartamento',
    terms: { PE: 'departamento', MX: 'departamento', AR: 'departamento', CO: 'apartamento', CL: 'departamento', ES: 'piso' },
  },
  {
    id: 'pool',
    defaultTerm: 'piscina',
    terms: { PE: 'piscina', MX: 'alberca', AR: 'pileta', CO: 'piscina', CL: 'piscina', ES: 'piscina' },
  },
  {
    id: 'mop',
    defaultTerm: 'fregona',
    terms: { PE: 'trapeador', MX: 'trapeador', AR: 'trapo de piso', CO: 'trapero', CL: 'trapero', ES: 'fregona' },
  },
  {
    id: 'baby-bottle',
    defaultTerm: 'biberón',
    terms: { PE: 'biberón', MX: 'mamila', AR: 'mamadera', CO: 'tetero', CL: 'mamadera', ES: 'biberón' },
  },
  {
    id: 'juice',
    defaultTerm: 'jugo',
    terms: { PE: 'jugo', MX: 'jugo', AR: 'jugo', CO: 'jugo', CL: 'jugo', ES: 'zumo' },
  },
  {
    id: 'sneakers',
    defaultTerm: 'zapatillas',
    terms: { PE: 'zapatillas', MX: 'tenis', AR: 'zapatillas', CO: 'tenis', CL: 'zapatillas', ES: 'zapatillas' },
  },
];
